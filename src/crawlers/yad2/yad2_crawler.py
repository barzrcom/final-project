...
class Crawler:
    ...
    def __init__(self, properties_per_page=1000):
...
if __name__ == '__main__':
    ...
    c_format = logging.Formatter('%(asctime)s [ %(funcName)-15s] %(levelname)s: %(message)s')
